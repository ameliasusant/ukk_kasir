		...
		while($d = mysqli_fetch_array($data)){
			...
			<?php if ($d['PelangganID'] == $PelangganID) { ?>
				...
				<form method="post" action="tambah_detail_penjualan.php">
					...
					<a class="navbar-brand" style="margin-left: 0rem;"><i class="fa-solid fa-cart-plus"></i>  Tambah Barang</a></i>
				</button>
				<a href="pembelian.php" class="btn btn-secondary btn-sm mt-2" type="button"><i class="fa-solid fa-lock-open"></i> Kembali</a>
				</form>
				<table class="table">
					<thead>
						<tr>
								...
								<tr>
									...
									<td>
										...
										<td>
											...
											<input type="text" name="DetailID" value="<?php echo $d_detailpenjualan['DetailID']; ?>" hidden>
											<input type="text" name="PelangganID" value="<?php echo $d['PelangganID']; ?>" hidden>
											<button type="submit" class="btn btn-success btn-sm"><i class="bi bi-pencil-square"></i> Proses</button>
										</div>
										</form>
				...
				<form method="post" action="simpan_total_harga.php">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<div class="form-group">
								<button class="btn btn-info btn-sm form-control" type="submit"><i class="bi bi-cloud-download-fill"></i> Simpan</button>
							</div>
						</div>
					</div>
				</form>
